...
<body>
	...
	<!--/boardInsert 로 보내는 post 방식 폼을 생성해주세요
	폼에서 보내는 요소의 name속성값은 쿼리문을 참조해서 만들어주세요
	insert로직을 실행하는 컨트롤러생성해주시고 return값은 "";로 우선 두겠습니다. 
	vo를 살펴본결과 title, content, writer 3개요소를 보내면 됨-->
