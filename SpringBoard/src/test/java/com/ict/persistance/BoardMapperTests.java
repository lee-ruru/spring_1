...
public class BoardMapperTests {
	...
	public void testGetList() {
		// log.info(boardMapper.getList());이렇게해도됨
	...
	// update 메서드에 대한 테스트 코드를 작성해주신다음
	// 수정여부를 getAllList()로 확인해보세요.
	//@Test
	public void testUpdate() {
		BoardVO board = new BoardVO();
		log.info("전달 데이터 아직 입력 안됨 vo : " + board);
	...
	boardMapper.update2("up2로바꾼제목", "up2로 바꾼본문 ", 2);
	}
	
	
	// 구문생성이 어떻게 되는지 관측하기 위한 테스트코드
